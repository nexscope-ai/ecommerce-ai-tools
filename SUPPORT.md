...
- **Bug report:** describe the expected and actual behavior, steps to reproduce, and any non-sensitive error code.
- **Feature request:** explain your goal, what is missing, and your current workaround.
- **Question:** name the tool and describe what you are trying to accomplish.

Search existing issues first. Add relevant details to an existing report when it describes the same problem.
...
Issues are public. Never include passwords, API keys, access tokens, payment details, or customer data. Redact screenshots and logs.

For private account, billing, or sensitive security questions, email [service@nexscope.ai](mailto:service@nexscope.ai). Describe the problem without sending your password or access token.
