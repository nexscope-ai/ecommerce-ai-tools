...
This is a hypothetical example, not a result from a new product test. For a documented sample with explicit counts, see the [Amazon review case study]({{ '/amazon-review-case-study/' | relative_url }}).
