...
keywords:
  ...
  - Merchant Center
  - visual shopping
image: /assets/images/google-ai-mode-shopping-1440w.webp
image_small: /assets/images/google-ai-mode-shopping-720w.webp
image_alt: A shopper using an AI-powered search journey to compare products, merchants, ratings, prices, and availability
image_caption: "Illustration: AI shopping discovery depends on current merchant data and product evidence that supports real comparisons."
faq:
  - question: What is Google AI Mode shopping?
    answer: "Google AI Mode shopping combines conversational or visual discovery with product and merchant information. Features and market availability vary, so merchants should check current Google Merchant Center and Search documentation."
  - question: Does product structured data guarantee visibility in AI Mode?
...
Availability, interfaces, ranking systems, and reporting can change. Use Google's [AI Mode shopping announcement](https://blog.google/products-and-platforms/products/shopping/google-shopping-ai-mode-virtual-try-on-update/) and [merchant updates](https://blog.google/products-and-platforms/products/shopping/google-shopping-updates-holiday-shopping/) as current reference points.
...
Google introduced the [Universal Commerce Protocol](https://blog.google/products/ads-commerce/agentic-commerce-ai-tools-protocol-retailers-platforms/) as an open commerce standard designed to support agentic interactions across participating platforms. Protocol support can make catalog and transaction capabilities available in supported flows; it is not an organic ranking shortcut.

For the broader picture, read the updated guide to [agentic commerce and AI shopping visibility](../what-is-agentic-commerce-ai-shopping-visibility/).
